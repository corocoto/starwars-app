...
export const EYE_COLOR_OPTIONS = [
  ...
  {
    value: COLORS.blueGray,
    label: COLORS.blueGray
  },
  {
    value: COLORS.black,
    label: COLORS.black
...
export const BODY_COLOR_OPTIONS = [
  ...
  {
    value: COLORS.greenTan,
    label: COLORS.greenTan
  },
  {
    value: COLORS.brown,
    label: COLORS.brown
...
export const RULES = {
  ...
  multiplyValuesValidator: [
    {
      validator: (_fieldSchema: RuleObject, values: string[]) => {
